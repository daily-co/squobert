            ...
            {isBlinking ? (
              ...
              <>
                ...
                {expression === "thinking" && (
                  <>
                    <path
                      d="M 90 180 A 20 20 0 0 1 110 160 L 110 180 Z"
                      fill="#fff"
                    />
                    <path
                      d="M 470 180 A 20 20 0 0 1 490 160 L 490 180 Z"
                      fill="#fff"
                    />
                  </>
                )}
      ...
      {(expression === "listening" ||
        ...
        <svg className="eyebrows" viewBox="0 0 600 400">
          <path
            d={
              expression === "nervous"
                ? "M 64 140 Q 84 145, 104 130"
                : "M 80 150 Q 100 140, 120 140"
            }
            fill="none"
            stroke="#000"
            strokeWidth="8"
          ...
          {(expression === "listening" || expression === "nervous") && (
            <path
              d={
                expression === "nervous"
                  ? "M 534 140 Q 514 145, 494 130"
                  : "M 520 150 Q 500 140, 480 140"
              }
              fill="none"
              stroke="#000"
              strokeWidth="8"
